            ...
            <div class="navbar">
                ...
                <nav>
                    <ul id="MenuItems">
                        ...
                        <li><a class='logout-btn' href='./index.php?logout=true'>Logout</a></li>
                    </ul>
                </nav>
                            ...
                            <div class="row m-l-0 m-r-0">
                                <div class="col-sm-4 bg-c-lite-green user-profile">
                                    <div class="card-block text-center text-white">
                                        ...
                                        <p><?php echo $_SESSION['username'] ?></p> <i class=" mdi mdi-square-edit-outline feather icon-edit m-t-10 f-16"></i>
                                    </div>
                                </div>
                                <div class="col-sm-8">
